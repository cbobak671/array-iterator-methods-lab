...
veryOldInventors = inventors.filter((inventor, year) => {
...
firstLast = people.map((firstAndLastName) => {
   let [lastName, firstName] = firstAndLastName.split(', ');
